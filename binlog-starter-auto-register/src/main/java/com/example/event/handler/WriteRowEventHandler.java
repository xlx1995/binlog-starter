 ...
 */
@Component
public class WriteRowEventHandler extends AbstractEventHandler {
    @Override
    public void convertData(EventContext context) {
        WriteRowsEventData rowsEventData = context.getEvent().getData();
        ...
        if (Objects.nonNull(metaInfo)) {
            ...
            for (Serializable[] row : rows) {
                ...
                customEvent.setOperation(OperateTypeEnum.INSERT.getCode());
